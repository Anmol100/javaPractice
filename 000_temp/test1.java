...
class test1 {
    public static void main(String args[]) {
        ...
        int len1,len2,len3,c = 0,n = 1,e = 0,f = 0,z = 0,h = 0;
        ...
        if (len1 != len2) {
            ...
            for(int l = 0; l < len1;l++){ 
                for (int index = str1.indexOf(ch1[l]);index >= 0;index = str1.indexOf(ch1[l], index + 1)){
                    ...
                    System.out.println("Letter " +ch1[l]+" occured "+e+" times in first string");
                h++;
                c += e;
                ch4[l] = e;
                if (c == len1){
            ...
            for(int m = 0;m < len1;m++){ 
                ...
                System.out.println("Letter " +ch2[m]+" occured "+f+" times in second string");
                z++;
                c += f;
                ch5[m] = f;
                if (c == len2){
            ...
            for (int i = 0;i < len1;i++){
                for (int j = 0;j < len1;j++){
                    if (ch1[i] == ch2[j]) {
                        ch3[i] = ch1[i];
                        System.out.println("ch3 = : " +ch3[i]+" at j = "+j+ " and i =" +i+"C = "+c);
                    }
                    c++; 
                }
            }
            ...
            System.out.println("ch3 length " +len3);
